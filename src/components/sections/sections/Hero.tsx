    ...
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-24 lg:py-32 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            {/* Glow behind image */}
            <div className="absolute inset-0 bg-gradient-to-br from-orange-500/10 via-transparent to-blue-500/10 rounded-3xl blur-3xl" />
            <motion.div
              animate={{ y: [0, -10, 0] }}
            ...
            >
              <Image
                ...
                alt="AutoBeres - Biro Jasa Kendaraan"
                width={600}
                height={400}
