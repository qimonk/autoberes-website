    ...
    <section id="kontak" className="py-20 md:py-28 bg-white dark:bg-navy-950">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          {/* Contact Info Cards + Illustration */}
          <motion.div
          ...
          >
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-orange-200/20 to-blue-200/20 rounded-2xl blur-2xl" />
              <Image
                src="/images/contact-illustration.png"
                alt="AutoBeres - Kontak"
                width={400}
                height={280}
